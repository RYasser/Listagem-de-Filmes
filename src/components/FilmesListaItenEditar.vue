<template>
    <div>
        ...
        <button @click="salvarFilme" class="btn btn-success float-right">Salvar</button>
    </div>
</template>
...
export default {
    ...
    computed: {
        filmeSelecionado: {
            // retornando um novo objeto com a propriedade editada
            set(dados) {
    ...
    methods: {
        salvarFilme() {
            // notificando para o filmeLista a alteração do novo valor
